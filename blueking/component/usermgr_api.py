...
BK_USERMGR_HOST = os.environ.get("BK_USERMGR_API_URL", "http://bkuserapi-web")
...
def esb_upsert_organization(name, **kwargs):
    """
    创建或更新组织
    """
    path = "/api/c/compapi/v2/usermanage//"
...
if settings.BK_LOGIN_API_AUTH_ENABLED:
    ...
    upsert_organization = esb_upsert_organization
else:
